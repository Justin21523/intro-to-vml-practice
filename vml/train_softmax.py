...
from .torch_models import TorchLinearClassifier, infer_num_classes, num_trainable_params
...
def train_softmax_from_splits(
    *,
    ...
    model, metrics = train_softmax(train_records, val_records, test_records, config=config)
